            ...
            <Grid item container xs={11} sx={{
                    ...
                    <>
                        <Grid item xs="auto">
                            <img style={{border: `4px solid ${theme.palette.primary.dark}`, borderRadius: 10}}
                                 src={comment.comment.image} alt="commentImage" width="100%" height={200}/>
                        </Grid>
                    </>
                }
                ...
                <Grid item xs={12}>
                    <Accordion
                        ...
                        >
                            <Typography
                                sx={{color: '#0095ff'}}>{comment.comment.numberOfComments > 0 ? `${comment.comment.numberOfComments} Comments` : 'Leave a Comment'}</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Grid container spacing={1}>
                                    ...
                                    <TextField
                                        ...
                                        InputProps={{
                                            ...
                                            endAdornment: <InputAdornment
                                                position="end">{`${newReply.message.length}/${MAX_COMMENT_LENGTH}`}</InputAdornment>
                                        }}
                                        inputProps={{
                                ...
                                </Grid>
                                {
                                    ...
                                    comment.replies.map((reply) => (
                                        <Reply key={reply.reply._id} reply={reply}
                                               handleSubReplySubmit={handleSubReplySubmit}
                                               user={user} newReply={newReply} setNewReply={setNewReply}
