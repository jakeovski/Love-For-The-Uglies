        ...
        <Paper elevation={3} sx={{
            ...
            <Grid container padding={1}>
                <Grid item xs={12} textAlign="center">
                    <Typography variant="h2" fontWeight="bold" fontFamily="Indie Flower">Love for the
                        Uglies!</Typography>
                </Grid>
                        ...
                        : animalOfTheDay.name ?
                            <Grid item container xs={12} alignItems="justify" spacing={1}>
                                ...
                                <Grid item container xs={12} xl={5} spacing={1} alignItems="center" sx={{
                                    ...
                                    <Grid item xs="auto">
                                        <Typography
                                            variant="subtitle1">{conservationStatusNames[animalOfTheDay.endangered]}</Typography>
                                    </Grid>
                                    <Grid item xs="auto">
                                        <Chip label={animalOfTheDay.endangered} sx={{
                                            color: 'white',
                                            backgroundColor: conservationStatus[animalOfTheDay.endangered]
                                        }}/>
                                    </Grid>
                                </Grid>
                                ...
                                <Grid item container xs={12} xl={4} justifyContent="center">
                                    <Grid item xs={10} md={8} xl={12} alignSelf="center" textAlign="center">
                                        <Typography variant="body2"
                                                    align="justify">{animalOfTheDay.description}</Typography>
                                    </Grid>
                                </Grid>
                                <Grid item xs={12} textAlign="center">
                                    <Typography variant="subtitle2">Source: <a style={{textDecoration: 'none'}}
                                                                               target="_blank"
                                                                               href={animalOfTheDay.source}>{animalOfTheDay.source}</a></Typography>
                                </Grid>
                            </Grid>
